...
import { Button, TextField, Paper, FormControl, Grid, Typography } from '@material-ui/core';
        ...
        <Grid style={{ display: "flex", flexDirection: "row" }}>
            ...
            <Grid className={classes.rightScreen}>
                ...
                <Grid className={classes.getStarted}>
                    <Typography variant="h3" style={{ paddingBottom: "1rem" }}>Get started!</Typography>
                    <form
                    ...
                    >
                        <FormControl className={classes.formControl}>
                            <TextField required
                                ...
                                onChange={e => {
                                    setInputFields(inputFields => ({ ...inputFields, firstName: e.target.value }))
                                    if (!e.target.value) {
                                        setErrors(errors => ({
                                            ...errors,
                                            firstName: true
                        ...
                        <FormControl className={classes.formControl}>
                            <TextField required
                                ...
                                onChange={e => {
                                    setInputFields(inputFields => ({ ...inputFields, lastName: e.target.value }))
                                    if (!e.target.value) {
                                        setErrors(errors => ({
                                            ...errors,
                                            lastName: true
                        ...
                        <FormControl className={classes.formControl}>
                            <TextField required
                                ...
                                onChange={e => {
                                    setInputFields(inputFields => ({ ...inputFields, email: e.target.value }))
                                    if (!e.target.value) {
                                        setErrors(errors => ({
                                            ...errors,
                                            email: true
                        ...
                        <FormControl className={classes.formControl}>
                            <TextField required
                                ...
                                onChange={e => { setInputFields(inputFields => ({ ...inputFields, password: e.target.value })) }}
                            />
                        </FormControl>
                        <FormControl className={classes.formControl}>
                            <TextField required
                                ...
                                onChange={e => { setInputFields(inputFields => ({ ...inputFields, confirmPassword: e.target.value })) }}
                            />
                        </FormControl>
                        <Button
