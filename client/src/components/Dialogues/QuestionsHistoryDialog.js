            ...
            <Box>
                {questions.map((question, num) => (
                    <Typography variant="h6" className={classes.feedbackDisplayItem}>
                        <Typography variant="h6" display="inline" color="primary">{num + 1}. </Typography>
                        {question}
                    </Typography>
                ))}
            </Box>
    ...
    return (
        ...
        >
            <DialogContent className={classes.feedbackMain}>
                <Button className={classes.rightButton} onClick={props.openSibling}>
                    <KeyboardArrowRightIcon />
                </Button>
                <Typography variant='h4' className={classes.feedbackTitle} id="feedback-form">Questions</Typography>
