  ...
  return (
    <>
      ...
      <MuiDialogTitle disableTypography className={classes.root} {...other}>
        <Typography className={classes.dialogTitle} variant="h5">{children}</Typography>
      </MuiDialogTitle>
    </>
  );
});
  ...
  return (
    <div>
      <Dialog
            ...
            <Grid container item direction='row'>
              <Grid container item md={6}>
                ...
                <TextField
                  ...
                  variant="outlined"
                  value={newlyCreatedInterview ? `http://localhost:3000/interview/${newlyCreatedInterview._id}` : null}
                />
              </Grid>
            ...
            <Grid container item direction='column' spacing={2}>
              ...
              <Grid container item className={classes.particpantsContent}>
                <Card elevation={0} style={{ paddingBottom: '1rem'}}>
                  <CardHeader
                      avatar={
                        <Avatar aria-label="recipe" src={facePhotoBoy} />
                      }
                      title={user.name}
        ...
        <DialogActions>
          <Button autoFocus onClick={goToInterview} size="large" variant="contained" color="primary">
            start
          </Button>
        </DialogActions>
      </Dialog>
