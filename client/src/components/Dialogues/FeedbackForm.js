...
function FeedbackRadioContainer(props) {
          ...
          return (
                    <Grid className={classes.feedbackRadioContainer}>
                              <FormLabel
                                        component="label"
                                        className={classes.feedbackRadioLabel}
                              >
                                        {props.label}
                              </FormLabel>
                              {props.children}
                              ...
                              return (
                                        <Grid>
                                                  ...
                                                  <DialogContent>
                                                            ...
                                                            <Grid
                                                                      className={
                                                                                classes.feedbackScoreTitleContainer
                                                                      }
                                                            >
                                                                      <Typography
                                                                                className={
                                                                                          classes.feedbackScoreTitle
                                                                                }
                                                                      >
                                                                                Needs
                                                                                Improvement
